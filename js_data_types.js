...
const iveWonYoung2 = `아이브 '"/ / / 장원영`; // Template Literal 1옆에 `
...
let init = null;
console.log(init);
console.log(typeof init); //object타입이라 나오는 이유는 버그이다. 실제로는 null타입이 맞다.
/**
 * Symbol 타입
 * 
 * 유일무이한 값을 생성할때 사용한다.
...
console.log(symbol1 === symbol2); //유일무이한 값이기에 함수별로 다르게 판별
...
console.log(dictionary['red']); //키값에 맞는 벨류를 출력
